...
@Ports({ @Port(name = "request", type = PortType.enforceable),
	@Port(name = "unrequest", type = PortType.enforceable) })
@ComponentType(initial = "zero", name = "org.bip.spec.priority.AnnoPetri")
public class AnnoPetri {
	...
	@Transition(name = "unrequest", source = "one", target = "zero")
	public void freeResource() {
		//System.out.println("The resource is releashed by " + petriId);
	}
